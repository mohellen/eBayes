...
bin/ForwardModel.o : src/model/ForwardModel.cpp src/model/ForwardModel.hpp
	$(CC) $(CFLAGS) $(INCLUDES) -c $< -o $@
	
bin/NS.o : src/model/NS.cpp src/model/NS.hpp src/model/ForwardModel.hpp 
	$(CC) $(CFLAGS) $(INCLUDES) -c $< -o $@
#
